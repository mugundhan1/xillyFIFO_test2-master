...
//  /   /         Filename : clk_man.v
// /___/   /\     Timestamp : 10/24/2016 05:17:59
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: xaw2verilog -st F:\XillyLBI\ver1\ipcore_dir\.\clk_man.xaw F:\XillyLBI\ver1\ipcore_dir\.\clk_man
//Design Name: clk_man
...
// For block PLL_ADV_INST, Estimated PLL Jitter for CLKOUT0 = 0.283 ns
`timescale 1ns / 1ps

module clk_man(CLKIN1_IN, 
               RST_IN, 
               CLKOUT0_OUT, 
               LOCKED_OUT);
   ...
   PLL_ADV #( .BANDWIDTH("OPTIMIZED"), .CLKIN1_PERIOD(10.000), 
         .CLKIN2_PERIOD(10.000), .CLKOUT0_DIVIDE(100), .CLKOUT0_PHASE(0.000), 
